export const titleTemplates = {
  en: {
    "Drug-Susceptible TB": (age, weight, months, regimenName) =>
      `Drug dosage for a person aged ${
        age === 0 ? `${months} months` : `${age} years`
  ...
  fr: {
    "Tuberculose pharmacosensible": (age, weight, months, regimenName) =>
      `Posologie du médicament pour une personne âgée de ${
        age === 0 ? `${months} mois` : `${age} ans`
  ...
  ru: {
    "Drug-Susceptible TB": (age, weight, months, regimenName) =>
      `Дозировка препарата для лица в возрасте ${
        age === 0 ? `${months} месяцев` : `${age} лет`
  ...
  es: {
    "Drug-Susceptible TB": (age, weight, months, regimenName) =>
      `Dosis del medicamento para una persona de ${
        age === 0 ? `${months} meses` : `${age} años`
